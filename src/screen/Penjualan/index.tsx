...
const Penjualan = () => {
  ...
  const [databarangDropdown, setDatabarangDropdown] = React.useState([]);
  ...
  const handleCreatePenjualan = () => {
    ...
    console.log(obj);
    // if (!Harga || !namabarangDropdown || !Kategori) {
    //   toast.show({
    //     render: () => {
    //       return (
    ...
    // } else {
    //   axios
    //     .post(`${API_URL}/api/barangDropdown`, obj)
    ...
    //               <Text color={"white"}>
    //                 Data barangDropdown Berhasil Dicreate
    //               </Text>
    //             </Box>
    //           );
    //         },
    ...
    >
      ...
      <Box width={"full"} alignItems={"center"}>
        <Stack space={4} w="100%" maxW="300px" mt={10}>
          ...
          />
          <Text>Subtotal Harga : {Harga}</Text>
          <HStack space={2}>
